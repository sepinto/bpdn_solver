...
Example usage (using generic AudioFile class objects):
    ...
    # set additional coding parameters that are needed for encoding/decoding
     coding_params.myParam = myParamValue
...
class AudioFile:
    ...
    def OpenForReading(self):
        ...
        coding_params = self.ReadFileHeader()  # this leaves the file pointer at the start of data and returns a CodingParams object w/ data from header
    ...
    def OpenForWriting(self, coding_params):
        ...
        self.WriteFileHeader(
            coding_params)  # this writes the file header and leaves the file pointer at the start of data portion
